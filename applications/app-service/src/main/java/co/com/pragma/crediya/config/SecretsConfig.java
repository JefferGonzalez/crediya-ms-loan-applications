...
public class SecretsConfig {
    ...
    @Bean
    public SQSSenderProperties sqsSenderProperties(
            final GenericManagerAsync connector, @Value("${aws.sqs.sender.secretName}") String secretName) throws SecretException {
        return connector.getSecret(secretName, SQSSenderProperties.class)
                .block();
    }
